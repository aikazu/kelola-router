...
const SEED: Array<Parameters<typeof upsertModel>[1]> = [
  ...
  },
  {
    ...
    pricing_input: null as unknown as number,
    pricing_output: null as unknown as number,
    pricing_cache_read: null as unknown as number,
    pricing_cache_write: null as unknown as number,
    source: 'builtin',
  },
];
