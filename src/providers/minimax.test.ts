...
import { PROVIDER, upstreamUrl, upstreamHeaders, type MinimaxAccount } from "./minimax.js";
...
describe("minimax provider", () => {
  ...
  it("upstreamUrl joins base URL + path", () => {
    const acc: MinimaxAccount = { provider: PROVIDER, apiKey: "k", baseUrl: "https://api.example.com" };
    expect(upstreamUrl(acc, "openai", "/v1/chat/completions")).toBe("https://api.example.com/v1/chat/completions");
  });
